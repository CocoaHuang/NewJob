...
//
//    if ([touch tapCount] == 2) {
//        [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(singleTapHandle) object:nil];
//        [self performSelector:@selector(doubleTapHandle) withObject:nil afterDelay:delayTime
//         ];
//    }
//    if ([touch tapCount] == 1) {
//        [self performSelector:@selector(singleTapHandle) withObject:nil afterDelay:delayTime];
//    }
//}
