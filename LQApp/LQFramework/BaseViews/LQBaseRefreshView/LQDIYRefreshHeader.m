...
//    self.loading.center = CGPointMake(self.mj_w - 30, self.mj_h * 0.5);
    ...
    self.leftLine.frame = CGRectMake(0, 0, self.bounds.size.width, 50);
}
...
- (void)setPullingPercent:(CGFloat)pullingPercent
{
    ...
    self.leftLine.drawNum = pullingPercent;

}

- (LQRefreshLeftLayer *)leftLine
{
    if (_leftLine == nil) {
        _leftLine = [LQRefreshLeftLayer layer];
    }
    return _leftLine;
}
